#In this we code to create a Graph with an Eulerian Tour

#There are two ways to do it.
#This one is simple method it connects four nodes by connecting 
# one after another. 1-2-3-4-1
def edge(x, y):
...
#This one is complex that involves some randomness.
